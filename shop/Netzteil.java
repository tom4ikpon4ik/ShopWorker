...
public class Netzteil{
    public static void getNetzteil() throws SQLException {

        Connection conn = DAOConnection.sqlconnection();      //Verbindung mit der DB
        try {
            System.out.println("Connected to Netzteil");
            String query = "SELECT * FROM SHOP.NETZTEIL";            //Auswahl aus Produkt DB
      ...
      System.out.println(ok);     */
            ...
            throw new IllegalStateException("Es gabe ein Problem", e);}}            //Probleme mit der SQL DB werden hier angezeigt
}